        ...
        child: Column(
          ...
          children: <Widget>[
           ...
           const SizedBox(height: 20),
            ...
            ElevatedButton(
              onPressed: (){
                //navigator.pop() removes the current page (register) and returnsto previous page (login)

                Navigator.pop(context); // go to login page when user registers
              },
            ...
            //sizedbox adds vertical spce between login button and text button
              ...
              TextButton(
                onPressed: (){
                  //navigating to Login when the text button is clicked
